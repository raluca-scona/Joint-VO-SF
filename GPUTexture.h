...
class GPUTexture
{
    public:
        ...
        static const std::string RGB, WEIGHT, DEPTH_RAW, DEPTH_FILTERED, DEPTH_METRIC, DEPTH_METRIC_FILTERED, DEPTH_NORM, DEPTH_STATIC_RAW, DEPTH_STATIC_FILTERED, DEPTH_STATIC_METRIC, DEPTH_STATIC_METRIC_FILTERED;
