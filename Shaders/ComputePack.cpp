...
const std::string ComputePack::STATIC_FILTER = "STATIC_FILTER";
const std::string ComputePack::METRIC = "METRIC";
const std::string ComputePack::METRIC_FILTERED = "METRIC_FILTERED";
const std::string ComputePack::STATIC_METRIC = "STATIC_METRIC";
const std::string ComputePack::STATIC_METRIC_FILTERED = "STATIC_METRIC_FILTERED";
