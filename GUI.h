...
class GUI
{
    public:
         ...
         : showcaseMode(showcaseMode)
        {
            ...
            drawFilteredCloud = new pangolin::Var<bool>("ui.Draw filtered", true, true);
            drawStaticCloud = new pangolin::Var<bool>("ui.Draw static", false, true);
