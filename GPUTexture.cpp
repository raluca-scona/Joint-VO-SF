...
const std::string GPUTexture::DEPTH_STATIC_RAW = "DEPTH_STATIC_RAW";
const std::string GPUTexture::DEPTH_STATIC_FILTERED = "DEPTH_STATIC_FILTERED";
const std::string GPUTexture::DEPTH_STATIC_METRIC = "DEPTH_STATIC_METRIC";
const std::string GPUTexture::DEPTH_STATIC_METRIC_FILTERED = "DEPTH_STATIC_METRIC_FILTERED";
